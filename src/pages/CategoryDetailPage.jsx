...
export default function CategoryDetailPage() {
  ...
  const productData = {
    ...
    location: data.location || "Telangana & Andhra Pradesh",
      ...
      <div className="mx-auto max-w-[1280px] px-4 pt-6 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[280px_minmax(0,1fr)]">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-wrap items-center rounded-2xl bg-red-50 px-5 py-4 text-[13px]">
              <span className="inline-flex items-center gap-2 font-semibold text-slate-800">
                <MapPin size={15} className="text-red-500" />
                Available in:
              </span>

              <span className="ml-2 font-medium text-red-600">Hyderabad</span>
              <span className="mx-2 text-slate-300">•</span>
              <span className="font-medium text-red-600">Vijayawada</span>
              <span className="mx-2 text-slate-300">•</span>
              <span className="font-medium text-red-600">Guntur</span>
              <span className="mx-2 text-slate-300">•</span>
              <span className="font-medium text-red-600">Warangal</span>
              <span className="mx-2 text-slate-300">•</span>
              <span className="font-medium text-red-600">AP & Telangana</span>
            </div>
            ...
            <div className="mt-4 space-y-2">
              <p className="text-[14px] leading-6 text-slate-700">
                {data.description ||
                  ...
                  } contact and business data across Andhra Pradesh and Telangana.`}
              </p>
        ...
        <div className="mt-16 bg-[#e8f6e8] px-4 py-8 sm:px-6">
          <div className="grid grid-cols-1 overflow-hidden border border-[#d4e8d4] md:grid-cols-2 lg:grid-cols-4">
            <div className="flex items-start gap-4 border-b border-[#d4e8d4] bg-[#dff1df] p-6 md:border-r lg:border-b-0">
              <div className="rounded-xl bg-green-600 p-4 text-white">
                <Zap size={22} />
              </div>
              <div>
                <h3 className="text-[15px] font-bold text-[#0f1535]">
                  Quick Delivery
                </h3>
            ...
            <div className="flex items-start gap-4 border-b border-[#d4e8d4] bg-[#dff1df] p-6 lg:border-b-0 lg:border-r">
              <div className="rounded-xl bg-green-600 p-4 text-white">
                <ShieldCheck size={22} />
              </div>
              <div>
            ...
            <div className="flex items-start gap-4 bg-[#dff1df] p-6">
              <div className="rounded-xl bg-green-600 p-4 text-white">
                <RotateCcw size={22} />
              </div>
              <div>
